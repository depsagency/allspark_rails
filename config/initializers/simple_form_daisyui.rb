...
SimpleForm.setup do |config|
  ...
  # DaisyUI wrapper optimized for our generator templates
  config.wrappers :daisyui, tag: "div", class: "form-control", error_class: "form-control", valid_class: "form-control" do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :minlength
    ...
    b.optional :min_max
    b.optional :readonly
    b.use :label, class: "label", error_class: "label"
    b.wrapper tag: "span", class: "label-text font-medium" do |ba|
      ba.use :label_text
    end
    b.use :input, class: "input input-bordered w-full", error_class: "input-error", valid_class: "input-bordered"
    b.use :full_error, wrap_with: { tag: "div", class: "label" }
    b.wrapper tag: "span", class: "label-text-alt text-error" do |ba|
      ba.use :error
    end
    b.use :hint, wrap_with: { tag: "div", class: "label" }
    b.wrapper tag: "span", class: "label-text-alt" do |ba|
      ba.use :hint
    end
  end

  # DaisyUI textarea wrapper
  config.wrappers :daisyui_textarea, tag: "div", class: "form-control", error_class: "form-control", valid_class: "form-control" do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :minlength
    ...
    b.use :input, class: "textarea textarea-bordered w-full", error_class: "textarea-error", valid_class: "textarea-bordered"
    b.use :full_error, wrap_with: { tag: "div", class: "label" }
    b.wrapper tag: "span", class: "label-text-alt text-error" do |ba|
      ba.use :error
    end
  ...
  config.wrappers :daisyui_select, tag: "div", class: "form-control", error_class: "form-control", valid_class: "form-control" do |b|
    b.use :html5
    b.use :placeholder
    b.optional :readonly
    b.use :label, class: "label", error_class: "label"
    ...
    b.use :input, class: "select select-bordered w-full", error_class: "select-error", valid_class: "select-bordered"
    b.use :full_error, wrap_with: { tag: "div", class: "label" }
    b.wrapper tag: "span", class: "label-text-alt text-error" do |ba|
      ba.use :error
    end
  ...
  # DaisyUI boolean wrapper
  config.wrappers :daisyui_boolean, tag: "div", class: "form-control", error_class: "form-control" do |b|
    b.use :html5
    b.optional :readonly
    b.wrapper tag: "label", class: "cursor-pointer label justify-start gap-4" do |ba|
      ba.use :input, class: "checkbox checkbox-primary", error_class: "checkbox-error"
      ba.use :label_text, class: "label-text font-medium", error_class: "label-text"
    end
    b.use :full_error, wrap_with: { tag: "div", class: "label" }
    b.wrapper tag: "span", class: "label-text-alt text-error" do |ba|
      ba.use :error
